    ...
    <div id="sidebar">
        <div id="top">
          <ul>
            ...
            <li className={currentPage === 'Charts' ? 'active' : ''}>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M11.5 0l1.72 1.72-4.22 4.22-3-3-5.5 5.5 1.061 1.061 4.439-4.439 3 3 5.28-5.28 1.72 1.72v-4.5z"></path><path d="M13 6.561v9.439h2v-11.439z"></path><path d="M10 9.561v6.439h2v-8.439z"></path><path d="M7 16h2v-5.439l-2-2z"></path><path d="M4 16h2v-8.439l-2 2z"></path><path d="M1 12.561v3.439h2v-5.439z"></path></svg>
          ...
          <ul>
            ...
            <li className={currentPage === 'Library' ? 'active' : ''}>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 18 16"><path d="M3.5 2h-3c-0.275 0-0.5 0.225-0.5 0.5v11c0 0.275 0.225 0.5 0.5 0.5h3c0.275 0 0.5-0.225 0.5-0.5v-11c0-0.275-0.225-0.5-0.5-0.5zM3 5h-2v-1h2v1z"></path><path d="M8.5 2h-3c-0.275 0-0.5 0.225-0.5 0.5v11c0 0.275 0.225 0.5 0.5 0.5h3c0.275 0 0.5-0.225 0.5-0.5v-11c0-0.275-0.225-0.5-0.5-0.5zM8 5h-2v-1h2v1z"></path><path d="M11.954 2.773l-2.679 1.35c-0.246 0.124-0.345 0.426-0.222 0.671l4.5 8.93c0.124 0.246 0.426 0.345 0.671 0.222l2.679-1.35c0.246-0.124 0.345-0.426 0.222-0.671l-4.5-8.93c-0.124-0.246-0.426-0.345-0.671-0.222z"></path></svg>
              <Link to="/">Library</Link>
            </li>
            <li className={currentPage === 'Liked Tracks' ? 'active' : ''}>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M5 3l11-3v11.5c0 1.381-1.567 2.5-3.5 2.5s-3.5-1.119-3.5-2.5c0-1.381 1.567-2.5 3.5-2.5 0.537 0 1.045 0.086 1.5 0.241v-5.15l-7 1.909v7.5c0 1.381-1.567 2.5-3.5 2.5s-3.5-1.119-3.5-2.5c0-1.381 1.567-2.5 3.5-2.5 0.537 0 1.045 0.086 1.5 0.241v-8.241z"></path></svg>
              <Link to="/likes/liked-tracks">Liked Tracks</Link>
            </li>
            <li className={currentPage === 'Liked Albums' ? 'active' : ''}>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M8 6.508c-0.823 0-1.492 0.669-1.492 1.492s0.669 1.492 1.492 1.492 1.492-0.669 1.492-1.492-0.669-1.492-1.492-1.492z"></path><path d="M8 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zM10.609 8c0 1.439-1.171 2.609-2.609 2.609s-2.609-1.171-2.609-2.609 1.171-2.609 2.609-2.609 2.609 1.171 2.609 2.609zM2.064 11.71l3.3-2.063c0.25 0.399 0.589 0.738 0.988 0.988l-2.063 3.3c-0.9-0.564-1.662-1.326-2.226-2.226zM10.636 6.353c-0.251-0.399-0.589-0.738-0.988-0.988l2.063-3.3c0.9 0.564 1.662 1.326 2.226 2.226l-3.3 2.063z"></path></svg>
              <Link to="/likes/liked-albums">Liked Albums</Link>
            </li>
          ...
          <ul>
            <li>Playlists</li>
            <li>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M14.5 4h-13c-0.275 0-0.5 0.225-0.5 0.5v11c0 0.275 0.225 0.5 0.5 0.5h13c0.275 0 0.5-0.225 0.5-0.5v-11c0-0.275-0.225-0.5-0.5-0.5zM12 12.5c0 0.828-0.895 1.5-2 1.5s-2-0.672-2-1.5 0.895-1.5 2-1.5c0.364 0 0.706 0.073 1 0.201v-2.915l-4 1.429v3.786c0 0.828-0.895 1.5-2 1.5s-2-0.672-2-1.5 0.895-1.5 2-1.5c0.364 0 0.706 0.073 1 0.201v-4.201l6-2v6.5z"></path><path d="M13.5 3h-11c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h11c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z"></path><path d="M12.5 1h-9c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h9c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z"></path></svg>
              Anti-Depressants
            </li>
            <li>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M14.5 4h-13c-0.275 0-0.5 0.225-0.5 0.5v11c0 0.275 0.225 0.5 0.5 0.5h13c0.275 0 0.5-0.225 0.5-0.5v-11c0-0.275-0.225-0.5-0.5-0.5zM12 12.5c0 0.828-0.895 1.5-2 1.5s-2-0.672-2-1.5 0.895-1.5 2-1.5c0.364 0 0.706 0.073 1 0.201v-2.915l-4 1.429v3.786c0 0.828-0.895 1.5-2 1.5s-2-0.672-2-1.5 0.895-1.5 2-1.5c0.364 0 0.706 0.073 1 0.201v-4.201l6-2v6.5z"></path><path d="M13.5 3h-11c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h11c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z"></path><path d="M12.5 1h-9c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h9c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z"></path></svg>
      ...
      () => {
        ...
        setUser('')
              ...
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M11 13l4.5-4.5-4.5-4.5v3h-7v3h7v3z"></path><path d="M1 1h11v2h-10v11h10v2h-11c-0.552 0-1-0.448-1-1v-13c0-0.552 0.448-1 1-1z"></path></svg>
              Logout
            </li>
          </ul>
        </div>
