            ...
            <div id="album-name-and-artist">
              ...
              <div id="album-artist-and-info">
                ...
                artistAvatar.data.album.artists.items.length > 1 ? (
                  ...
                  <>
                    {artistAvatar.data.album.artists.items[0].visuals
                      .avatarImage &&
                    artistAvatar.data.album.artists.items[0].visuals.avatarImage
                      ...
                      <>
                        ...
                        <span>
                          <Link
                            to={`/artist/${artistAvatar.data.album.artists.items[0].uri.slice(
                              -22
                            )}`}
                            onClick={() => {
                              clearData();
                          ...
                          >
                            {
                              artistAvatar.data.album.artists.items[0].profile
                                .name
                            }
                          </Link>
                        </span>
                    ...
                    <div class="track-title">
                      ...
                      <div>
                        {artists.map((artist, i) => {
                          ...
                          return (
                            <span key={id}>
                              <Link to={`/artist/${id}`} className="name">
                                {name}
                              </Link>
