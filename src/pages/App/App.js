...
function App () {
  ...
  const getAlbumLibrary = async () => {
    if(user){
      ...
      setAlbumLibrary(data.filter(usersPosts => usersPosts.userId === user._id))
      
      let artistDict = {} 
      let filteredArr = []

      let artists = data.filter(usersPosts => 
        usersPosts.userId === user._id && 
        usersPosts.musicType === 'album').map(item => 
          ({
            ...
            <main id="container">
              ...
              <div id="content">
                ...
                <Routes>
                  ...
                  <Route path='/track/:spotifyId' element={<TrackPage 
                    user={user}
                    newAlbum={newAlbum}
                    setNewAlbum={setNewAlbum}
                    trackInfo={trackInfo}
                  ...
                  <Route path='/artist/:spotifyId' element={<ArtistPage 
                    setAlbumInfo={setAlbumInfo}
                  ...
                  <Route path='/playlist/:spotifyId' element={<PlaylistPage 
                  ...
                  <Route path='/likes/liked-tracks' element={<LikedTracksPage 
                    albumLibrary={albumLibrary}
                    setCurrentPage={setCurrentPage}
                    getAlbumLibrary={getAlbumLibrary}
                    shortenNum={shortenNum}
                  ...
                  <Route path='/likes/liked-albums' element={<LikedAlbumsPage 
                    albumLibrary={albumLibrary}
                    setCurrentPage={setCurrentPage}
                    clearData={clearData}
                    update={update}
